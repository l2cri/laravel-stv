...
class CommentsSupplierDataTable extends DataTable
{
    ...
    public function ajax()
    {
        return $this->datatables
            ...
            ->editColumn('moderated', function($comment) {
                ...
                return '<a href="'.route('panel::supplierComments.toggle', $comment->id).'" title="'.$title.'"><i class="fa fa-'.$checkClass.'"></i></a>';

            })
            ->addColumn('action', function($comment){

                return '<a href="'.route('panel::supplierComments.delete', $comment->id).'" title="Удалить"><i class="fa fa-remove"></i></a>';
    ...
    public function query()
    {
        ...
        $comments = Comment::where('commentable_id',$supplierId)
            ->where('commentable_type','App\Models\Supplier')
    ...
    public function html()
    {
        return $this->builder()
            ...
            ->ajax( [
                'url' => route('supplierComments.datatables'),
            ])
